...
const Pinconfig_t GPIOPins[]={
		...
		/* Selecting functionality GPIO for selected Pins */
		 { LPC_GPIO0,  P0_16,  FUNC0  },      //SPI_SSEL_0
		 { LPC_GPIO0,  P0_4,   FUNC0  },      //P0_4
		 { LPC_GPIO0,  P0_5,   FUNC0  },      //P0_5
};

const Pinconfig_t SPIPins[]={

		/* Selecting functionality SPI0 for selected Pins */
		 {  LPC_GPIO0,  SCK,   FUNC3  },      //SPI_SCK_0
		 {  LPC_GPIO0,  MISO,  FUNC3  },      //SPI_MISO_0
		 {  LPC_GPIO0,  MOSI,  FUNC3  },      //SPI_MOSI_0
};
...
void vPinmuxInitialize(void)
{
	...
	vPinmuxSel(GPIOPins[0].GPIOx, GPIOPins[0].pin, GPIOPins[0].func); //SPI_SSEL_0
	vPinmuxSel(GPIOPins[1].GPIOx, GPIOPins[1].pin, GPIOPins[1].func); //P0_4
	vPinmuxSel(GPIOPins[2].GPIOx, GPIOPins[2].pin, GPIOPins[2].func); //P0_5

	/* Selecting functionality SPI0 for selected Pins */
	vPinmuxSel(SPIPins[0].GPIOx, SPIPins[0].pin, SPIPins[0].func); //SPI_SCK_0
	vPinmuxSel(SPIPins[1].GPIOx, SPIPins[1].pin, SPIPins[1].func); //SPI_MISO_0
	vPinmuxSel(SPIPins[2].GPIOx, SPIPins[2].pin, SPIPins[2].func); //SPI_MOSI_0
}
